    ...
    <div class="form-container">
        <form action="/upload/register_process.jsp" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" class="form-control" required placeholder="재능을 잘 표현할 수 있는 제목을 입력해주세요">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" class="form-control" required placeholder="제공하실 재능에 대해 상세히 설명해주세요"></textarea>
                <div class="error-message" id="descriptionError">설명을 입력해주세요.</div>
            </div>

            <div class="form-group">
                <label for="price" class="form-label">가격 (원)</label>
                <input type="number" id="price" name="price" class="form-control" required min="0" placeholder="제공하실 재능의 가격을 입력해주세요">
